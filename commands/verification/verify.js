...
const collector = message.channel.createMessageCollector(filter, { time: 150000 });
        ...
        roblox.getIdFromUsername(username).then(id => {
          ...
          message.channel.send(new Discord.RichEmbed().setTitle("Please put the following token in your profiles description").setDescription(`**${tokenID}**`).setFooter("When you have done that, say done").setColor("#2ecc71")).then(() => {
